...
namespace SharpSvn {
    ...
    public ref class SvnLookInheritedPropertyListEventArgs : public SvnCancelEventArgs
    {
    ...
    internal:
        SvnLookInheritedPropertyListEventArgs(const char *path, apr_hash_t* prop_hash, AprPool ^pool)
        {
            if (!path)
